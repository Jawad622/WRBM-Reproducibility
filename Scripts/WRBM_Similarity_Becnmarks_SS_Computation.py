# -*- coding: utf-8 -*-
"""
Created on Wed Mar 29 14:40:03 2023
...
def get_SimBenchmark(benchMark):# This method returns the Benchmark of specific type.
    df=df_SimBenchmarks.loc[df_SimBenchmarks["benchMark"] == benchMark]
    print(benchMark)
    print(len(df))
    return df
...
kfreq=200
#[MC, RG65, WS203, SimLex]
benchMark='MC'
index=hashedindex.HashedIndex()

df_dstokenic = pd.read_csv("AlldsTokensDF.txt",sep="\t")
df_SimBenchmarks=pd.read_csv("Similarity_Benchmarks.txt",sep="\t")
df=get_SimBenchmark(benchMark)
